...
class Page_m extends My_Model {
    ...
    public $rules = array(
        'parent_id' => array('field' => 'parent_id',
                         'label' => 'Parent',
                         'rules' => 'trim|intval'),
        'title' => array('field' => 'title',
                         'label' => 'Title',
                         'rules' => 'trim|required|max_length[100]|xss_clean'),
        'template' => array('field' => 'template',
                         'label' => 'Template',
                         'rules' => 'trim|required|xss_clean'),
        'slug' => array('field' => 'slug',
                         'label' => 'Slug',
                         'rules' => 'trim|required|max_length[100]|callback__unique_slug|url_title|xss_clean'),
    ...
    public function get_archive_link() {
        $page = parent::get_by(array('template'=>'archive'), TRUE);
